...
public class FillerScriptFields implements Filler{
    ...
    public LabWork creationsLabwork(String username) {
        LabWork lab = new LabWork(readName(), readCoordinates(), LocalDate.now(), readMinimalPoint(), readDifficulty(), readPerson(), username);
    ...
    public LabWork updateLabwork(int id) {
        LabWork lab = new LabWork(id, readName(), readCoordinates(), LocalDate.now(), readMinimalPoint(), readDifficulty(), readPerson());
        if (switcher & labSwitcher) {
            return lab;
        } else {
            return null;
